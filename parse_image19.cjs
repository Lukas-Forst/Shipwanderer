...
const img6 = new Image(); img6.src = fs.readFileSync('public/ship/tile006.png');
const c6 = createCanvas(w, h); const ctx6 = c6.getContext('2d');
ctx6.drawImage(img6, 0, 0); const d6 = ctx6.getImageData(0, 0, w, h).data;
...
console.log(" tile000 config 22:", testTile(data));
console.log(" tile006 config 22:", testTile(d6));
